const Admissions = [
     ...
     },
    {
      ...
      data: [
        {
          para:
           "Schedule for reporting, classes and orientation programme for newly admitted UG/PG/Ph.D students",
     ...
     },
     {
      ...
      data: [
        {
          para:
           "Provisional list of Candidates eligible for admission in PhD ",
